        ...
        <div class="main-content">
            ...
            <form id="login-sheet-form" action="process_loginsheet.php" method="post">
                ...
                <div class="form-group form-group-span-3">
                    ...
                    <input type="text" id="patient_id" name="patient_id" placeholder="ID (e.g., 02000123456, CLN012A, or NA)" value="<?= htmlspecialchars($form_data['patient_id'] ?? '') ?>">
                    <div id="patient_id-error" class="error"><?= isset($errors['patient_id']) ? implode('<br>', $errors['patient_id']) : '' ?></div>
                </div>
                <div class="form-group">
                    <label for="name">NAME / *REQUIRED</label>
                    <input type="text" id="name" name="name" placeholder="Name" required value="<?= htmlspecialchars($form_data['name'] ?? '') ?>" <?= $existing_record ? 'readonly' : '' ?>>
                    <div id="name-error" class="error"><?= isset($errors['name']) ? implode('<br>', $errors['name']) : '' ?></div>
                </div>
                <div class="form-group">
                    ...
                    <div id="gender-error" class="error"><?= isset($errors['gender']) ? implode('<br>', $errors['gender']) : '' ?></div>
                </div>
                <div class="form-group">
                    ...
                    <input type="hidden" id="birthday" name="birthday" value="<?= htmlspecialchars($form_data['birthday'] ?? '') ?>">
                    <div id="birthday-error" class="error"><?= isset($errors['birthday']) ? implode('<br>', $errors['birthday']) : '' ?></div>
                </div>
                <div class="form-group">
                    <label for="age">AGE</label>
                    <input type="number" id="age" name="age" placeholder="Age" required value="<?= htmlspecialchars($form_data['age'] ?? '') ?>" <?= $existing_record ? 'readonly' : '' ?>>
                    <div id="age-error" class="error"><?= isset($errors['age']) ? implode('<br>', $errors['age']) : '' ?></div>
                </div>
                <div class="form-group">
                    <label for="role">ROLE / *REQUIRED</label>
                    <input type="text" id="role" name="role" placeholder="Enter Role" required value="<?= htmlspecialchars($form_data['role'] ?? '') ?>">
                    <div id="role-error" class="error"><?= isset($errors['role']) ? implode('<br>', $errors['role']) : '' ?></div>
                </div>
                <div class="form-group">
                    <label for="course_section">COURSE AND SECTION / *REQUIRED if student</label>
                    <input type="text" id="course_section" name="course_section" placeholder="Course and Section" value="<?= htmlspecialchars($form_data['course_section'] ?? '') ?>" <?= $existing_record ? 'readonly' : '' ?>>
                    <div id="course_section-error" class="error"><?= isset($errors['course_section']) ? implode('<br>', $errors['course_section']) : '' ?></div>
                </div>
                <div class="form-group">
                    <label for="blood_pressure">BLOOD PRESSURE</label>
                    <input type="text" id="blood_pressure" name="blood_pressure" placeholder="e.g., 120/80 or NA" value="<?= htmlspecialchars($form_data['blood_pressure'] ?? '') ?>">
                    <div id="blood_pressure-error" class="error"><?= isset($errors['blood_pressure']) ? implode('<br>', $errors['blood_pressure']) : '' ?></div>
                </div>
                <div class="form-group">
                    <label for="heart_rate">HEART RATE (BPM)</label>
                    <input type="text" id="heart_rate" name="heart_rate" placeholder="Heart Rate or NA" value="<?= htmlspecialchars($form_data['heart_rate'] ?? '') ?>">
                    <div id="heart_rate-error" class="error"><?= isset($errors['heart_rate']) ? implode('<br>', $errors['heart_rate']) : '' ?></div>
                </div>
                <div class="form-group">
                    <label for="blood_oxygen">BLOOD OXYGEN (%)</label>
                    <input type="text" id="blood_oxygen" name="blood_oxygen" placeholder="Oxygen Level or NA" value="<?= htmlspecialchars($form_data['blood_oxygen'] ?? '') ?>">
                    <div id="blood_oxygen-error" class="error"><?= isset($errors['blood_oxygen']) ? implode('<br>', $errors['blood_oxygen']) : '' ?></div>
                </div>
                <div class="form-group form-group-span-2">
                    <label for="height">HEIGHT (cm)</label>
                    <input type="text" id="height" name="height" placeholder="Height (cm) or NA" value="<?= htmlspecialchars($form_data['height'] ?? '') ?>">
                    <div id="height-error" class="error"><?= isset($errors['height']) ? implode('<br>', $errors['height']) : '' ?></div>
                </div>
                <div class="form-group">
                    <label for="weight">WEIGHT (kg)</label>
                    <input type="text" id="weight" name="weight" placeholder="Weight (kg) or NA" value="<?= htmlspecialchars($form_data['weight'] ?? '') ?>">
                    <div id="weight-error" class="error"><?= isset($errors['weight']) ? implode('<br>', $errors['weight']) : '' ?></div>
                </div>
                <div class="form-group">
                    <label for="temperature">TEMPERATURE (°C)</label>
                    <input type="text" id="temperature" name="temperature" placeholder="Temperature (Celsius) or NA" value="<?= htmlspecialchars($form_data['temperature'] ?? '') ?>">
                    <div id="temperature-error" class="error"><?= isset($errors['temperature']) ? implode('<br>', $errors['temperature']) : '' ?></div>
                </div>
                <div class="form-group">
                    <label for="time_out">TIME OUT</label>
                    <input type="time" id="time_out" name="time_out" value="<?= htmlspecialchars($form_data['time_out'] ?? '') ?>">
                    <div id="time_out-error" class="error"><?= isset($errors['time_out']) ? implode('<br>', $errors['time_out']) : '' ?></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="medicine" name="medicine">
                        ...
                        <?php foreach ($medicines as $medicine): ?>
                            <option value="<?= htmlspecialchars($medicine) ?>" <?= isset($form_data['medicine']) && $form_data['medicine'] === $medicine ? 'selected' : '' ?>><?= htmlspecialchars($medicine) ?></option>
                        <?php endforeach; ?>
                    </select>
                    <div id="medicine-error" class="error"><?= isset($errors['medicine']) ? implode('<br>', $errors['medicine']) : '' ?></div>
                </div>
                <div class="form-group">
                    <label for="quantity">QUANTITY</label>
                    <input type="number" id="quantity" name="quantity" placeholder="Quantity" value="<?= htmlspecialchars($form_data['quantity'] ?? '') ?>">
                    <div id="quantity-error" class="error"><?= isset($errors['quantity']) ? implode('<br>', $errors['quantity']) : '' ?></div>
                </div>
                <div class="form-group"></div>
                <div class="form-group">
                    <label for="purpose_of_visit">PURPOSE OF VISIT / *REQUIRED</label>
                    <textarea id="purpose_of_visit" name="purpose_of_visit" rows="3" placeholder="Enter Purpose of Visit"><?= htmlspecialchars($form_data['purpose_of_visit'] ?? '') ?></textarea>
                    <div id="purpose_of_visit-error" class="error"><?= isset($errors['purpose_of_visit']) ? implode('<br>', $errors['purpose_of_visit']) : '' ?></div>
                </div>
                <div class="form-group">
                    <label for="health_history">HEALTH HISTORY / *REQUIRED</label>
                    <textarea id="health_history" name="health_history" rows="3" placeholder="Enter Health History"><?= htmlspecialchars($form_data['health_history'] ?? '') ?></textarea>
                    <div id="health_history-error" class="error"><?= isset($errors['health_history']) ? implode('<br>', $errors['health_history']) : '' ?></div>
                </div>
                <div class="form-group">
                    <label for="remarks">REMARKS / *REQUIRED</label>
                    <textarea id="remarks" name="remarks" rows="3" placeholder="Enter Remarks"><?= htmlspecialchars($form_data['remarks'] ?? '') ?></textarea>
                    <div id="remarks-error" class="error"><?= isset($errors['remarks']) ? implode('<br>', $errors['remarks']) : '' ?></div>
                </div>
